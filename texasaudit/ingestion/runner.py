...
from texasaudit.database import get_session, SyncStatus, SyncStatusEnum
...
class SyncRunner:
    ...
    def _run_sync(self, source: str) -> SyncTask:
        ...
        try:
            if source == "cmbl":
                from texasaudit.ingestion.cmbl import CMBLIngestor
                ...
                from texasaudit.ingestion.socrata import SocrataIngestor
                ...
                from texasaudit.ingestion.lbb import LBBIngestor
                ...
                from texasaudit.ingestion.usaspending import USASpendingIngestor
                ...
                from texasaudit.ingestion.txsmartbuy import TxSmartBuyIngestor
                ...
                from texasaudit.ingestion.salaries import SalariesIngestor
                ...
                from texasaudit.ingestion.taxpermits import TaxPermitsIngestor
                ...
                from texasaudit.ingestion.comptroller import ComptrollerPaymentsIngestor
                ...
                from texasaudit.ingestion.ethics import EthicsIngestor
                ...
                from texasaudit.ingestion.sam_exclusions import SAMExclusionsIngestor
    ...
    def _run_socrata_parallel(self, task: SyncTask) -> int:
        ...
        from texasaudit.database import get_session, Payment, Vendor
    ...
    def _run_usaspending(self, task: SyncTask) -> int:
        ...
        from decimal import Decimal
        import requests
        from texasaudit.database import get_session, Grant, Vendor, Agency
        from texasaudit.normalization import normalize_vendor_name, normalize_fiscal_years
        from texasaudit.config import config
