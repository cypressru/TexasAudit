"""
Configuration management for Texas Audit.
...
class Config:
    ...
    def _apply_env_overrides(self) -> None:
        ...
        env_mappings = {
            "TEXASAUDIT_DB_HOST": ("database", "host"),
            "TEXASAUDIT_DB_PORT": ("database", "port"),
            "TEXASAUDIT_DB_NAME": ("database", "name"),
            "TEXASAUDIT_DB_USER": ("database", "user"),
            "TEXASAUDIT_DB_PASSWORD": ("database", "password"),
            "TEXASAUDIT_SOCRATA_TOKEN": ("api_keys", "socrata"),
            "TEXASAUDIT_WEB_HOST": ("web", "host"),
            "TEXASAUDIT_WEB_PORT": ("web", "port"),
            "TEXASAUDIT_DATA_DIR": ("data", "data_dir"),
        }
