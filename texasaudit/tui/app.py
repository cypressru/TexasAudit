"""Main TUI Application for Texas Audit."""
...
try:
    from texasaudit.database import Employee, CampaignContribution, TaxPermit, EntityMatch, DebarredEntity
...
class TexasAuditApp(App):
    """Texas Audit Terminal UI."""
    ...
    def action_sync(self) -> None:
        ...
        from texasaudit.ingestion import run_sync
        try:
            results = run_sync()
